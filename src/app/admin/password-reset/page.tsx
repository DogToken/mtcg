    ...
    <div style={{
      ...
      <main style={{ width: '100%', maxWidth: 900, padding: '0 32px' }}>
        <section style={{
          ...
          <h2 style={{ fontSize: 28, fontWeight: 700, marginBottom: 24, textAlign: 'center' }}>Admin Password Reset</h2>
          <p style={{ textAlign: 'center', marginBottom: 24, color: '#a0a0a0', fontSize: 14 }}>
            Generate password reset links for any user account.
          </p>
          ...
          <div style={{ textAlign: 'center', marginTop: 18 }}>
            <a href="/dashboard" className="neon-link">Back to Dashboard</a>
          </div>
        </section>
      </main>
    </div>
